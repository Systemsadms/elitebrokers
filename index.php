...
<!---------------------------------------------------------HEAD------------------------------------------------------------------>
    <div id="MarcoHead">    
        ...
        <div id="nombre">
                <table width="588" border="0" align="left">
                  <tr>
                    <td width="450" align="center"><h1><font color="white" face="Lucida Sans Unicode, Lucida Grande, sans-serif">Elite Broker Services Corp C.A</font><br><br />
...
<!---------------------------------------------------------BANNER ------------------------------------------------------------------>    
    ...
    <div id="loginbox">
        ...
        <!-- SnapWidget -->
        <iframe src="http://snapwidget.com/sc/?u=ZWxpdGVicm9rZXJzZXJ2aWNlc3xpbnwxNTB8M3wzfHxub3w1fG5vbmV8b25TdGFydHx5ZXN8bm8=&ve=190515" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:200px; height:95px">
        </iframe>		
